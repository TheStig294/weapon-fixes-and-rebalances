-- Here lies all of the changes to weapon descriptions, because a heck of a lot of weapons
-- don't really describe what they do in the buy menu
if engine.ActiveGamemode() ~= "terrortown" then return end

hook.Add("PreRegisterSWEP", "StigWeaponDescriptionChanges", function(SWEP, class)
